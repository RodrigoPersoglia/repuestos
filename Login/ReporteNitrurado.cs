...
namespace Login
{
	public partial class ReporteNitrurado : Form
	{
		string usuario;
		public ReporteNitrurado()
		{
			InitializeComponent();
		}

		public ReporteNitrurado(string user)
		{
			usuario = user;
			InitializeComponent();
		}
		...
		void BuscarClick(object sender, EventArgs e)
		{
			...
			DataTable dt = Conexion.ReporteNitrurado(decimal.ToInt32(Num1.Value), decimal.ToInt32(Num2.Value), decimal.ToInt32(Num3.Value));
			Cuadro.Rows.Clear();
			if (dt != null)
			{
				foreach (DataRow x in dt.Rows)
				{
					...
					Cuadro.Rows[n].Cells[5].Value = (int)x[5];
        ...
        private void ReporteNitrurado_Load(object sender, EventArgs e)
        {
