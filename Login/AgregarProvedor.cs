...
namespace Login
{
	public partial class AgregarProvedor : Form
	{
		public AgregarProvedor()
		{InitializeComponent();}
        ...
        private void AgregarCliente_Load(object sender, EventArgs e)
        {
			...
			string consulta8 = "select max(c.numero) from proveedor c limit 1";
			decimal numero = 0;
			try
			{
		...
		private void Crear_Click(object sender, EventArgs e)
		{
			...
			{
				Conexion.CrearProveedor(DirFisc_Txt.Text, (int)LocFis_Cbx.SelectedValue,CPFisc.Text, DirEntrega_txt.Text, (int)LocEnt_Cbx.SelectedValue,CPEnt.Text, (int)NumCliente.Value, Alias_Txt.Text, RazonSocial_Txt.Text, (long)NumDoc.Value, Tel1_tex.Text, Tel2_text.Text, (int)TipoDoc_Cbx.SelectedValue, (int)IVA_Cbx.SelectedValue);
				// Limpiar datos
