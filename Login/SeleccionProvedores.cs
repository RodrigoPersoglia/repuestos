...
namespace Login
{
	public partial class SeleccionProvedores : Form
	{
		...
		// Constructor
		public SeleccionProvedores(string texto){InitializeComponent();
        ...
        private void SeleccionProvedores_Load(object sender, EventArgs e)
        {
